...
export const metadata: Metadata = {
  title: "Terms of Service | Tesilix",
  description: "The terms that govern your use of Tesilix.",
};
...
export default function TermsPage() {
  return (
    <LegalLayout title="Terms of Service" updated="June 2026">
      ...
      <h2>1. What Tesilix is</h2>
      <p>
        Tesilix is a marketplace that helps employers discover and contact
        skilled workers, and helps workers showcase their skills and find jobs.
        Tesilix is
      ...
      <ul>
        <li>You must be at least 18 years old to use Tesilix.</li>
        <li>
      ...
      <h2>4. Payments</h2>
      <p>
        Unless stated otherwise, payments for work are arranged and made
        directly between employers and workers. Tesilix does not process
        payments for jobs and takes no commission on agreed rates for founding
        workers.
      </p>
      ...
      <ul>
        ...
        <li>
          Use the platform for unlawful purposes or to bypass our safeguards.
        </li>
      ...
      <p>
        You retain ownership of content you post, but grant Tesilix a licence to
      ...
      <p>
        Tesilix is provided &ldquo;as is&rdquo;. To the fullest extent permitted
        by law, Tesilix is not liable for the conduct of any user, for any job
        or service arranged through the platform, or for any indirect or
        consequential loss. You use Tesilix at your own risk and should take
        normal precautions when hiring or working.
      </p>

      <h2>8. Suspension & termination</h2>
      <p>
        We may suspend or terminate accounts that breach these terms or that we
        reasonably believe pose a risk to the community. You may stop using
        Tesilix and delete your account at any time.
      </p>

      <h2>9. Changes</h2>
      <p>
        We may update these terms from time to time. We&rsquo;ll post the
        updated version here with a new date; continued use of Tesilix means you
        accept the changes.
      </p>
    </LegalLayout>
  );
